      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            ...
            <p className="text-sm text-zinc-400">{testimonials[active].designation}</p>
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="h-10 w-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center group/button transition-colors"
            >
